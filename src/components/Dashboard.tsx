...
const DashCount: FC<PropsCount> = ({ children, ...props }) => {
  return (
    <div className="p-2 w-[250px] h-[100px] rounded-[16px] font-[500] bg-white drop-shadow-lg flex flex-col items-center">
    ...
    <div className="p-4 w-[350px] h-[120px] rounded-[16px] bg-white drop-shadow-lg">
      <div className="flex justify-between">
        <div className="relative">
          <div>
            <img src="../assets/images/badge.png" alt="" width="75%"></img>
          </div>
          <div className="absolute top-1 right-10 text-white font-[12px]">
            {children.count}
          </div>
        </div>
...
const DashLocRed: FC<PropsLoc> = ({ children }) => {
  return (
    <div className="p-4 w-[350px] h-[120px] rounded-[16px] bg-white shadow-red">
      <div className="flex justify-between">
        <div className="relative">
          <div>
            <img src="../assets/images/badge.png" alt="" width="75%"></img>
...
const DashLocGreen: FC<PropsLoc> = ({ children }) => {
  return (
    <div className="p-4 w-[350px] h-[120px] rounded-[16px] bg-white shadow-green">
      <div className="flex justify-between">
        <div className="relative">
          <div>
            <img src="../assets/images/badge.png" alt="" width="75%"></img>
...
export { DashCount, DashLoc, DashLocRed, DashLocGreen };
